  ...
  create: async (data) => {
    ...
    const newOrder = {
      ...
      payment: {
        ...
        status: 'pending',
        qris_code: '00020101021226590014ID.CO.QRIS.WWW0118936000140000000000021500000000000000000303UME51440014ID.CO.QRIS.WWW02150000000000000005204731153033605802ID5920GourmetHub Mock6009Jakarta6105123456304CA43'
      },
